  ...
  return (
    <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-md border border-slate-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
      ...
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl md:text-3xl font-bold text-slate-100 tracking-tight">Create Account</h2>
        <p className="text-slate-400 text-sm mt-2">Get started with your AI-driven job hunt</p>
      </div>
